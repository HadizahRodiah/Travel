  ...
  return (
    <div className='w-screen py-20 relative'>
      <div className='p-10 bg-white flex flex-col flex-wrap justify-between py-12 md:flex-row' id='service'>
        ...
        {/* Services Section */}
        <div className='w-full py-10 text-center flex flex-col justify-between md:flex-row flex-wrap items-center'>
          {[
            {
            ...
            <div
              key={index}
              className='flex flex-col shadow-lg rounded-lg bg-slate-400 p-5 w-full md:w-96 m-2 transition-transform duration-300 hover:bg-white hover:shadow-xl hover:scale-105'
            >
