  ...
  return (
    <div className='py-20 bg-slate-900 max-w-full overflow-x-hidden' id='footer'>
      <div className='flex flex-row justify-between px-20 font-bold'>
        <li className='flex flex-row text-white mb-2'>
      ...
      <div className='flex flex-col md:flex-row justify-between p-10'>
        <div className='p-10 w-96'>
          ...
          <li className='flex flex-row text-white mb-2 w-32 hover:bg-black'>
            <a><Icons.Whatsapp width={25} height={25} className='text-white mr-3'/></a>Whatsapp
          </li>
          <li className='flex flex-row text-white mb-2 w-32 hover:bg-black'>
            <a><Icons.Envelope width={25} height={25} className='text-white mr-3'/></a>Email
          </li>
          <li className='flex flex-row text-white mb-2 w-32 hover:bg-black'>
            <a><Icons.Facebook width={25} height={25} className='text-white mr-3'/></a>Facebook
          </li>
          <li className='flex flex-row text-white mb-2 w-32 hover:bg-black'>
            <a><Icons.Telephone width={25} height={25} className='text-white mr-3'/></a>Phone
          </li>
          <li className='flex flex-row text-white mb-2 w-32 hover:bg-black'>
            <a><Icons.Linkedin width={25} height={25} className='text-white mr-3'/></a>LinkedIn
          </li>
        </div>
        ...
        <div className='w-96 p-10'>
          <div className='mb-3 text-white flex flex-col'>
            ...
            <label htmlFor='exampleInputEmail1' className='form-label text-white font-bold'>Email address</label>
            <input
              type='email'
              id='subscribeEmail'
      ...
      <p className='item-center flex justify-center text-slate-500'>&copy; All rights reserved</p>
    </div>
  );
};
