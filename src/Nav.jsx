...
const Nav = () => {
  ...
  return (
    <>
      <nav className="bg-white text-black border-b border-slate-900 px-6 md:px-16 lg:px-24 w-full fixed top-0 left-0 z-50 overflow-x-hidden">
        <div className="container mt-2 py-4 flex justify-between items-center">
          {/* Logo Section */}
          <div className="text-2xl font-bold flex items-center">
            <Icons.StarFill width={30} height={30} className="text-slate-900" />
            <span className="ml-2">Travel&Tour</span>
          </div>
        ...
        {isMenuOpen && (
          <>
            ...
            {/* Mobile Menu Content */}
            <div className="fixed top-0 right-0 w-3/4 max-w-sm bg-white shadow-lg z-50 h-full p-6 overflow-y-auto">
              <div className="flex flex-col space-y-6">
                <div className="text-2xl font-bold flex items-center">
                  <Icons.StarFill width={30} height={30} className="text-slate-900" />
                  <span className="ml-2">Travel&Tour</span>
                </div>
                <a href="#home" className="block py-2 font-semibold hover:text-green-700">Home</a>
                <a href="#resort" className="block py-2 font-semibold hover:text-green-700">Resort</a>
                <a href="#review" className="block py-2 font-semibold hover:text-green-700">Review</a>
                <a href="#service" className="block py-2 font-semibold hover:text-green-700">Service</a>
